        ...
        return(
            ...
            <div>
                <div id="main" class="w3-animate-meme w3-gothic w3-white">
                    ...
                    <p class=" w3-large">Sprint 2 is afoot! This week the plan is to implement some backend features such as login
                     ...
                     of companies that was implemented this week. </p>
            ...
            <div id="main"  class="w3-animate-meme w3-gothic   w3-white">
                    ...
                    the pictures below the login page and the page for listing orders can be seen. 
